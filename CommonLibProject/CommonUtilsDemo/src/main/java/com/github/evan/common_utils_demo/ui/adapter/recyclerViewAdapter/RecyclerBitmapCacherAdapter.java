...
import com.github.evan.common_utils_demo.ui.holder.recyclerViewHolder.StaggeredBitmapCacherHolder;
import com.github.evan.common_utils_demo.ui.holder.recyclerViewHolder.StaggeredHolder;

/**
 * Created by Evan on 2017/11/21.
 */
public class RecyclerBitmapCacherAdapter extends SwitchRecyclerAdapter<String> {

    public RecyclerBitmapCacherAdapter(Context context) {
        super(context);
    }
    ...
    public BaseRecyclerViewHolder<String> onCreateHolderWithSwitchMode(View itemView, ViewGroup parent, int viewType, int switchMode) {
        ...
        if(switchMode == LIST_MODE_VERTICAL){
            ...
            holder = new StaggeredBitmapCacherHolder(parent.getContext(), itemView);
        }
        else {
