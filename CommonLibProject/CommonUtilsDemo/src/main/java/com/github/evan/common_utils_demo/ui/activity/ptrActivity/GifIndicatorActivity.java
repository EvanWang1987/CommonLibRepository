 ...
 */
public class GifIndicatorActivity extends BaseActivity implements PullToRefreshSwitcher, OnRefreshListener {
    @BindView(R.id.ptr_layout_gif_indicator)
    ...
    public int getLayoutResId() {
        return R.layout.activity_gif_indicator_with_ptr;
    }
