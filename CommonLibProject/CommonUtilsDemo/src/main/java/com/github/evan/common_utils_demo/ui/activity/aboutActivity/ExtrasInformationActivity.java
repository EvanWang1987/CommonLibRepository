 ...
 */
public class ExtrasInformationActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, ResourceUtil.getStringArray(R.array.task_stack_menu));
