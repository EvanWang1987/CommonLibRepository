...
/**
 * Created by Evan on 2018/2/6.
 */
public class VerticalTimeFlagIndicator extends LinearLayout implements IIndicator{
    private ImageView mIcArrow, mIcProgress;
    private TextView mTxtTitle, mTxtDesc;

    public VerticalTimeFlagIndicator(Context context) {
        super(context);
        init();
    }

    public VerticalTimeFlagIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VerticalTimeFlagIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init(){
        LayoutInflater.from(getContext()).inflate(R.layout.indicator_vertical_time_flag, this, true);
