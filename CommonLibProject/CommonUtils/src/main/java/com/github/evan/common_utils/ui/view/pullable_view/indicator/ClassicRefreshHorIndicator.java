...
public class ClassicRefreshHorIndicator extends LinearLayout implements IIndicator {
    ...
    public ClassicRefreshHorIndicator(Context context) {
        super(context);
        init(null, 0);
    }

    public ClassicRefreshHorIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public ClassicRefreshHorIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void onPullStatusChange(PullStatus status) {
        ...
        switch (status) {
            ...
            case RELEASE_TO_INVOKE:
                ...
                if (mLastPullStatus == PullStatus.LEFT_PULLING || mLastPullStatus == PullStatus.RIGHT_PULLING) {
                    mArrowUpAnim.start();
                }
                break;
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.indicator_classic_ptr_hor, this, true);
