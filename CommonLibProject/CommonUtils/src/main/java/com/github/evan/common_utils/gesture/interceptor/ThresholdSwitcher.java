...
public class ThresholdSwitcher {
    ...
    public void dispatchThreshold(MotionEvent event, InterceptMode interceptMode, View dst, ThresholdSwitchable thresholdSwitchable) {
        ...
        if (actionMasked == MotionEvent.ACTION_DOWN) {
            ...
            if (interceptMode == InterceptMode.ALL_BY_MYSELF_BUT_THRESHOLD || interceptMode == InterceptMode.HORIZONTAL_BUT_THRESHOLD || interceptMode == InterceptMode.VERTICAL_BUT_THRESHOLD) {
                ...
                Logger.d(dst.getClass().toString() + "intercept mode: " + interceptMode + " arriveTouchEventThreshold: " + arriveTouchEventThreshold);
